...
namespace DynamicForm.Areas.Permission.Controllers
{
    ...
    public class PermissionManagementController : ControllerBase
    {
        ...
        public async Task<ActionResult<Group>> GetGroup([FromRoute] Guid id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status400BadRequest)]
        public async Task<ActionResult<PermissionModel>> CreatePermission([FromBody] CreatePermissionRequest request)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<PermissionModel>> GetPermission([FromRoute] Guid id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<Function>> GetFunction([FromRoute] Guid id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> UpdateFunction([FromRoute] Guid id, [FromBody] UpdateFunctionRequest request)
        {
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> DeleteFunction([FromRoute] Guid id)
        {
            if (await _permissionService.GetFunctionAsync(id) is null)
                return NotFound();
        ...
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<ActionResult<Menu>> GetMenu([FromRoute] Guid id)
        {
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> UpdateMenu([FromRoute] Guid id, [FromBody] UpdateMenuRequest request)
        {
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> AssignUserToGroup([FromRoute] Guid groupId, [FromBody] AssignUserGroupRequest request)
        {
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        public async Task<IActionResult> AssignGroupFunctionPermission([FromRoute] Guid groupId, [FromBody] AssignGroupFunctionPermissionRequest request)
        {
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]
        public async Task<IActionResult> RemoveGroupFunctionPermission([FromRoute] Guid groupId, [FromRoute] Guid functionId, [FromRoute] Guid permissionId)
        {
